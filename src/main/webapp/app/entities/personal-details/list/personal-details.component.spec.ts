...
describe('PersonalDetails Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'personal-details', component: PersonalDetailsComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to personalDetailsService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getPersonalDetailsIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getPersonalDetailsIdentifier).toHaveBeenCalledWith(entity);
