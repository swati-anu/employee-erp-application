...
import { EntityArrayResponseType, PersonalDetailsService } from '../service/personal-details.service';
...
export class PersonalDetailsComponent implements OnInit {
  ...
  trackId = (_index: number, item: IPersonalDetails): number => this.personalDetailsService.getPersonalDetailsIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.personalDetails = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IPersonalDetails[] | null): IPersonalDetails[] {
    return data ?? [];
  }
  ...
  protected queryBackend(
    ...
    return this.personalDetailsService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
